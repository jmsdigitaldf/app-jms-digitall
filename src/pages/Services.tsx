      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-gray-600">Os valores apresentados são estimativas. O preço final pode variar após análise técnica completa.</p>
          </div>
          <div className="flex items-start gap-3">
            <Badge variant="secondary">2</Badge>
            <p className="text-sm text-gray-600">Para orçamentos acima de R$ 500, é necessário aprovação do gerente.</p>
          </div>
          <div className="flex items-start gap-3">
            <Badge variant="secondary">3</Badge>
            <p className="text-sm text-gray-600">Todos os serviços possuem garantia de 90 dias para o mesmo problema.</p>
          </div>
        </CardContent>
      </Card>
    </div>
